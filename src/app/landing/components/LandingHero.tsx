...
export const LandingHero = () => {
    return (
        <div className="relative">
            <div className="absolute inset-0 -top-2 h-[1600px] w-full bg-[url(/images/landing/hero-bg-gradient.svg)] bg-no-repeat opacity-25 dark:opacity-15" />

            <div className="relative z-10 container py-28 xl:py-40">
                <div className="flex flex-col items-center">
                    <Link
                        className="badge badge-secondary rounded-full"
